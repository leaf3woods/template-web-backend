...
builder.Host.ConfigureContainer<ContainerBuilder>(config =>
    config.RegisterAssemblyModules(Assembly.GetExecutingAssembly(), Assembly.Load("Template.Web." + nameof(Template.Web.Application))));
...
var scopes = Assembly.Load("Template.Web.Application").GetTypes()
...
// Add mapper profiles
builder.Services.AddAutoMapper(config => config.AddMaps(Assembly.Load("Template.Web." + nameof(Template.Web.Application))));

// Add mediatR
builder.Services.AddMediatR(config =>
    config.RegisterServicesFromAssemblies(Assembly.Load("Template.Web." + nameof(Template.Web.Application))));
